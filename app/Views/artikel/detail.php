  ...
  <div class="container">
    ...
    <div class="article-section">
      ...
      <div class="profile-info">
        <h2 style="font-size: 30px; font-weight: 700; margin-left: 50px; margin-top: -10px;"><?= ($lang == 'id') ? $artikel->title_artikel : $artikel->title_artikel_en; ?>
        </h2>
        <p class="article-content"><?= ($lang == 'id') ? $artikel->deskripsi_artikel : $artikel->deskripsi_artikel_en; ?>
        </p>
      </div>
    </div>
    <div class="footer">
